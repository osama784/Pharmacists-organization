...
import { loginZodSchema, passwordResetZodSchema, sendPasswordResetEmailSchema } from "../validators/auth.schema.js";
...
router.patch("/reset-password", validate(passwordResetZodSchema), resetPassword);
