...
import UserSchema, { RoleSchema } from "../validators/UserSchema.js";
...
router.patch("/update-role/:roleID", authenticated, checkPermission(permissions.updateRole), validate(RoleSchema.partial()), updateRole);
